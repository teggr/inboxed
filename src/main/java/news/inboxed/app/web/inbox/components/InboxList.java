...
public class InboxList {
        ...
        public static DomContent inboxItems(Page<InboxItem> inboxItems) {
                return div().withId("inbox-items").with(
                                ...
                                each(div().withClasses(row, bg_light, border_top, py_1).with(
                                                div().withClasses(col_auto, pt_1)
                                                                .with(span().withClasses("bi", "bi-star")),
                                                ...
                                                div().withClasses(row, bg_light, border_top, border_bottom, py_1).with(
                                                                ...
                                                                div().withClasses(col_2)
                                                                                .with(text(item.subscriptionName())),
                                                                div().withClasses(col).with(
                                                                                strong().withText(item.title()),
                                                                                span(item.summary()).withClasses()),
                                                                div().withClasses(col_auto).with(text(
                                                                                news.inboxed.app.web.utils.TimeUtils
                                                                                                .formatInstant(item
                                                                                                                .date()))),
                                                                div().withClasses(col_auto, pt_1)
                                                                                .with(span().withClasses("bi",
